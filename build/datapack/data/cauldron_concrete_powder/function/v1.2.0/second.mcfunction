...
#> cauldron_concrete_powder:v1.2.0/second
#
# @within	cauldron_concrete_powder:v1.2.0/tick
#
...
execute if score #check cauldron_concrete_powder.dropped matches 1.. run function cauldron_concrete_powder:v1.2.0/check_dropped
