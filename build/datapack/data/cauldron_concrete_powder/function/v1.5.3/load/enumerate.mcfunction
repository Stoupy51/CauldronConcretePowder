...
#> cauldron_concrete_powder:v1.5.3/load/enumerate
#
...
execute if score #cauldron_concrete_powder.major load.status matches 1 if score #cauldron_concrete_powder.minor load.status matches 5 unless score #cauldron_concrete_powder.patch load.status matches 3.. run scoreboard players set #cauldron_concrete_powder.patch load.status 3
