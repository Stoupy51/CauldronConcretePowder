...
#> cauldron_concrete_powder:v1.3.3/second
#
# @within	cauldron_concrete_powder:v1.3.3/tick
#
...
execute if score #check cauldron_concrete_powder.dropped matches 1.. run function cauldron_concrete_powder:v1.3.3/check_dropped
