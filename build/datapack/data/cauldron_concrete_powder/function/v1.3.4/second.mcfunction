...
#> cauldron_concrete_powder:v1.3.4/second
#
# @within	cauldron_concrete_powder:v1.3.4/tick
#
...
execute if score #check cauldron_concrete_powder.dropped matches 1.. run function cauldron_concrete_powder:v1.3.4/check_dropped
