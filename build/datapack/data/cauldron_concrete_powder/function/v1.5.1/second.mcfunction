...
#> cauldron_concrete_powder:v1.5.1/second
#
# @within	cauldron_concrete_powder:v1.5.1/tick
#
...
execute if score #check cauldron_concrete_powder.dropped matches 1.. run function cauldron_concrete_powder:v1.5.1/check_dropped
