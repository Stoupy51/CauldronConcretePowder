...
#> cauldron_concrete_powder:v1.3.0/load/enumerate
#
...
execute if score #cauldron_concrete_powder.major load.status matches 1 if score #cauldron_concrete_powder.minor load.status matches 3 unless score #cauldron_concrete_powder.patch load.status matches 0.. run scoreboard players set #cauldron_concrete_powder.patch load.status 0
